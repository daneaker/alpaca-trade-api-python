...
API_KEY = "PK1Q6S6XEJDW7UHVXSC5"
API_SECRET = "NjuiLYKCBhQrMhCdG/zNvRkWEHrw4IsyBeJ7ZCzu"
...
class LongShort:
  def __init__(self):
    ...
    stockUniverse = ['DOMO', 'TLRY', 'SQ', 'MRO', 'AAPL', 'GM', 'SNAP', 'SHOP', 'SPLK', 'BA', 'AMZN', 'SUI', 'SUN', 'TSLA', 'CGC', 'SPWR', ]
