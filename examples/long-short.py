...
API_KEY = "PK948GFFLVPRUEUFWTOP"
API_SECRET = "rpbnmz0juPRBq6ek8SNhpWHzW4CFj55Le7cbiCO2"
...
class LongShort:
  def __init__(self):
    ...
    stockUniverse = ['AGNC','AI','ANH','ARR','CHMI','CMO','NLY','ORC','DX','CIM','EFC','IVR','MFA','MITT','TWO','WMC','NYMT','NRZ','PMT','REM','MORT',]
